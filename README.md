...
Bedrock for model access, [Envoy AI Gateway](https://aigateway.envoyproxy.io/) for the model data plane, [DRA](https://kubernetes.io/docs/concepts/scheduling-eviction/dynamic-resource-allocation/) for accelerator scheduling.
