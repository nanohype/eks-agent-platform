...
type IAM interface {
	...
	// Inline-policy lifecycle for the per-tenant bedrock-model-scoping policy
	// (reconciled from Platform.spec.identity.allowedModelFamilies /
	// allowedModels by the PlatformReconciler).
